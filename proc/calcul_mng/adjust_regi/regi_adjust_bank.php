...
$bank_price = $fb->form("bank_price");
$bank_name = $fb->form("bank_name");
$bank_memo = $fb->form("bank_memo");
...
$param_pay_history["col"]["cont"] = $bank_memo;
$param_pay_history["col"]["adjust_price"] = 0;
$param_pay_history["col"]["depo_price"] = $bank_price;
