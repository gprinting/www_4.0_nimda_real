...
//echo 'Element is a Closing bracket',PHP_EOL;
				...
				$d = $stack->last(2);
				if (isset($d['value']) && !is_null($d['value']) && preg_match('/^'.self::CALCULATION_REGEXP_FUNCTION.'$/i', $d['value'], $matches)) { // if (!is_null($d['value']) && preg_match('/^'.self::CALCULATION_REGEXP_FUNCTION.'$/i', $d['value'], $matches)) { //if (preg_match('/^'.self::CALCULATION_REGEXP_FUNCTION.'$/i', $d['value'], $matches)) {	//	Did this parenthesis just close a function?
