...
var catePaperSelect = function(code, chk){

    var url = "/ajax/order/order_common_mng/load_paper_list.php";
    var data = {
        "sortcode"    : code
    };

    var callback = function(result) {
        $("#cate_paper").append(result);
        if(chk == undefined){
            var cate_paper = $("#val_paper").val();
            $("#cate_paper").val(cate_paper);
        }
