...
var orderFn = {
    //주문상세 리스트
    "list"       : function() {
        var url = "/ajax/manufacture/web_sheet_typset_regi_popup/load_order_detail_list.php";
        ...
        var callback = function(result) {
            var rs = result.split("♪");
            if (rs[0].trim() == "") {
                $("#order_detail_list").html(blank);
                return false;
            }
            $("#order_detail_list").html(rs[0]);
            $("#order_detail_page").html(rs[1]);
        };
    ...
    "pop"       : function(seqno) {
       alert("준비중입니다.");
/*
        var url = "/ajax/manufacture/web_sheet_typset_regi_popup/load_board_div_pop.php";
        var data = { 
            "amt_order_detail_sheet_seqno" : seqno 
        };
...
var typsetFn = {
    "view"       : function() {
        ...
        var url = "/ajax/manufacture/web_sheet_typset_regi_popup/load_typset_view.php";
        var data = { 
            "typset_num" : $("#typset_num").val() 
        };
    ...
    "modi"       : function() {
        ...
        var url = "/proc/manufacture/web_sheet_typset_regi_popup/modi_typset_info.php";
        var data = { 
            "typset_num"                       : $("#typset_num").val(),
...
var afterFn = {
    ...
    //후공정 수정
    "op"       : function() {
        var url = "/proc/manufacture/web_sheet_typset_regi_popup/modi_basic_after_op.php";
        var data = { 
...
var produceFn = {
    //조판확인 리스트
    "list"       : function() {
        var url = "/ajax/manufacture/web_sheet_typset_regi_popup/load_produce_list.php";
        var data = { 
            "typset_num" : $("#typset_num").val()
        };
    ...
    //생산 시작 및 검수 완료
    "start"       : function() {
        var url = "/proc/manufacture/web_sheet_typset_regi_popup/modi_produce_start.php";
        var data = {
            "typset_num" : $("#typset_num").val()
        };
