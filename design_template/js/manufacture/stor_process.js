        ...
        var callback = function(result) {
            ...
            for(i = 1 ; i <= length; i++) {
                ...
                if (a_obj.order_num != null) {
                    ...
                    $("#member_name_"+ i).text(a_obj.member_name);
                    $("#typset_num_"+ i).text(a_obj.typset_num);
...
var findButton = function() {
    order_num = $("#order_num").val();
    change = $(":input:radio[name=changestate_yn]:checked").val();
...
function copyToTable(idx) {
    ...
    $clone.find("#typset_num_1").attr({"id" : "order_num_" + idx});
    $clone.find("#name_1").attr({"id" : "title_" + idx});
