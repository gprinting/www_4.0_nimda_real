...
var getNowState = function(typset_num) {
    ...
    var callback = function(result) {
        var url2 = "/proc/manufacture/print_list/modi_print_process_multi_finish.php";
        ...
        if(state == "") {
            ...
            ajaxCall(url2, "html", {"seqno": sheet_typset_seqno, "state": "2330", "barcode_start_char": barcode_start_char}, callback2);
        }
        else if(state == "2330") {
            ajaxCall(url2, "html", {"seqno": sheet_typset_seqno, "state": "2420", "barcode_start_char": barcode_start_char}, callback2);
        }
        else
