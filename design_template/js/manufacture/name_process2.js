...
var searchProcess2 = function() {
    ...
    if(selectedValue == ""){
        alert("먼저 판정보를 조회후 선택하세요");
    }

    var url = "/ajax/manufacture/stor_list/load_stor_process.php";
...
var searchProcess2 = function() {
    ...
    var typset_num = $("#panId option:selected").val();

    if(typset_num == undefined){
        alert("먼저 판정보를 조회하세요");
    }
    else{
       alert(typset_num+" - 작업중입니다.");
...
*/
    ...
    var searchProcess = function(showPage, page) {
        ...
        var url = "/ajax/manufacture/output_list/load_imposition_list2.php";
        var blank = "<tr><td colspan=\"9\">검색 된 내용이 없습니다.</td></tr>";
        var data = {
...
var getNowState = function(typset_num) {
    ...
    var data = {
        "typset_num" : defined_typset_num
    };

    var callback = function(result) {
        var url2 = "/proc/manufacture/cutting_list/modi_cutting_process_multi_finish.php";
        ...
        if(state == "2420") {
            ajaxCall(url2, "html", {"seqno": sheet_typset_seqno, "state": "2430", "barcode_start_char": barcode_start_char}, callback2);
        }
        else if(state == "2430") {
            ajaxCall(url2, "html", {"seqno": sheet_typset_seqno, "state": "2480", "barcode_start_char": barcode_start_char}, callback2);
        }
        else
            searchProcess(defined_typset_num);
    };
