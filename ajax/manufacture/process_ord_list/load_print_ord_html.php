...
$param["col"] = "regi_date, oper_sys, typset_format_seqno, paper_name, beforeside_tmpt, aftside_tmpt,
    ...
    sheet_typset_seqno, after_list, print_etprs, dvs ";
...
$memo = $rs->fields["memo"];
$print_title = $rs->fields["dvs"] . "-" . $rs->fields["print_title"];
...
$html .= "\n  <td headers=\"txt1\">" . $print_title . "</td>";
...
$html .= "\n  <td headers=\"txt9\" class=\"txt9\">" . $memo . "</td>";
