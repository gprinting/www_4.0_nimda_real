...
while($rs && !$rs->EOF) {
    ...
    $ordernum = $rs->fields['order_num'];
    $title = $rs->fields['title'];
    $point = $rs->fields['use_point_price'];
    $sellprice = $rs->fields['sell_price'];
    $payprice = $rs->fields['pay_price'];
    $date = $rs->fields['order_regi_date'];
...
echo getPointUsePopup($html_param);
