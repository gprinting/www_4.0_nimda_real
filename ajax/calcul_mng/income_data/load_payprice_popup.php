...
$rs = $dao->selectMemberPayPriceList($conn, $param);
//$rs2 = $dao->selectMemberPayPriceList2($conn, $param);
$i = 0;
$all_depo_price = 0;
...
while($rs && !$rs->EOF) {
    ...
    $depo_price = number_format($rs->fields['adjust_price'] * -1) . "원";
    $all_depo_price += $rs->fields['adjust_price'] * -1;
...
echo getPaypricePopup($html_param);
